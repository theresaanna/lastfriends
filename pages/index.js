    ...
    <Layout>
      <div className="py-8">
        ...
        <div className="max-w-2xl mx-auto mb-6">
          <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-4 fade-in-up">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-yellow-800">Spotify Development Mode</h3>
                <div className="mt-2 text-sm text-yellow-700">
                  <p>
                    This app is in development mode for Spotify. If you would like access for Spotify testing, please email{' '}
                    <a href="mailto:theresasumma@gmail.com" className="font-medium underline hover:text-yellow-600">
                      theresasumma@gmail.com
                    </a>
                    . Priority access given to potential employers to evaluate my work.
                  </p>
                  <p className="mt-2">
                    This restriction is due to an opaque Spotify API policy that prohibits individuals from gaining production access to their API. My apologies for this inconvenience.
                  </p>
                  <p className="mt-2 font-medium">
                    Last.fm integration is still working and available for your perusal.
                  </p>
                </div>
              </div>
            </div>
